...
| --| --| --|--|--|--|
| QualityAttr01| 제안서 검색 시간 최소화| 사용성| 상| 상| systemFeature-01|
| QualityAttr02| 통합 데이터 관리| 보안성, 변경관리성| 상| 상| systemFeature-01|
| QualityAttr03| 다양한 플랫폼(모바일)| 편의성, 변경가능성| 중| 상| systemFeature-02, systemFeature-03|
| QualityAttr04| 인증을 통한 권한 체크| 보안성| 상| 중| systemFeature-04|

### 3.2.2 제안서 검색 시간 최소화 (QualityAttr01)
* QA Type: 사용성
...
### 3.2.4 다양한 플랫폼(모바일) (QualityAttr03)
* QA Type: 편의성, 변경가능성
